...
- (nonnull id)initWithType:(nonnull NSString *)type
                floatArray:(nonnull NSArray *)floatArray
                  intArray:(nonnull NSArray *)intArray
...
@property (nonatomic, readonly, nonnull) NSArray * floatArray;

/** array of integer data */
@property (nonatomic, readonly, nonnull) NSArray * intArray;
